...
export const MainContent: React.FC<MainContentProps> = ({ onFormSubmit }) => {
  ...
  return (
    <main className="justify-center items-stretch shadow-[2px_4px_6px_0_rgba(12,15,36,0.08)] flex min-w-60 flex-col grow shrink w-[1056px] bg-white p-6 rounded-lg max-md:max-w-full max-md:px-5">
