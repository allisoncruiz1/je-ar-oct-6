  ...
  return (
    <div className="bg-[rgba(239,241,247,1)] overflow-hidden min-h-screen">
      ...
      <div className="flex w-full flex-col items-stretch">
        ...
        <div className="items-center flex w-10 gap-2.5 h-10 bg-[#1B489B] mt-6 p-2 rounded-full max-md:mt-6 ml-auto max-md:fixed max-md:bottom-32 max-md:right-4 max-md:shadow-lg max-md:w-8 max-md:h-8 max-md:p-1.5">
          <img
